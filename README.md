# Risky Delivery 0.2.0 — 위험한 택배 배달
...
전달용 파일은 `Builds/Packages/RiskyDelivery-0.2.0-Windows.zip`입니다. 압축을 풀고 폴더 안의 실행 파일을 엽니다. `Docs/PLAYER_GUIDE.md`도 패키지에 `README.txt`로 포함합니다.
